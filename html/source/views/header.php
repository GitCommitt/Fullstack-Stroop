...
<header class="intro">
  ...
  <svg class="wave-1" viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
    ...
    <path class="wave wave2" d="M0 474L26.7 470.2C53.3 466.3 106.7 458.7 160 454C213.3 449.3 266.7 447.7 320 447C373.3 446.3 426.7 446.7 480 451.3C533.3 456 586.7 465 640 470.8C693.3 476.7 746.7 479.3 800 479.3C853.3 479.3 906.7 476.7 933.3 475.3L960 474L960 541L0 541Z" fill="#523e28"></path>
    <path class="wave wave3" d="M0 512L26.7 507.5C53.3 503 106.7 494 160 494C213.3 494 266.7 503 320 505.5C373.3 508 426.7 504 480 498.5C533.3 493 586.7 486 640 483.7C693.3 481.3 746.7 483.7 800 489.3C853.3 495 906.7 504 933.3 508.5L960 513L960 541L0 541Z" fill="#312313"></path>
  </svg>
</header>
